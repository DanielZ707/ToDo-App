...
public class PutTaskHandlerTest {
    ...
    @Test
    @Timeout(1)
    void shouldReturnOKStatusForGivenUpdatedTask() throws IOException, InterruptedException {
        //given
        ...
        String substring = httpResponse1.body().substring(7, 43);

        String body2 = "{'description': 'Zjedz jablko'}";
        var httpRequest4 = HttpRequest.newBuilder()
                .uri(URI.create(TODO_APP_PATH + "task/" + substring))
                .setHeader("auth", "amFuS293YWxza2k=:YW0hc0sjMTIz")
                .version(HttpClient.Version.HTTP_1_1)
        ...
        //when
        var httpResponse2 = httpClient.send(httpRequest4, ofString());
        System.out.println(httpResponse2.body());

        //then
        assertThat(httpResponse2.statusCode()).as("Response status code").isEqualTo(200);
