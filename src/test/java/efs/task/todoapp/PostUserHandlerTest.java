...
public class PostUserHandlerTest {
    ...
    @Test
    @Timeout(1)
    void shouldReturnCreatedStatusForGivenUser() throws IOException, InterruptedException {
        //given
        ...
        //then
        assertThat(httpResponse.statusCode()).as("Response status code").isEqualTo(201);
